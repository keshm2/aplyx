...
```bash
curl -L -o aplyx-0.9.85a.zip https://github.com/keshm2/aplyx/archive/refs/tags/0.9.85a.zip && \
  unzip aplyx-0.9.85a.zip && cd aplyx-0.9.85a   # or the release page's "Source code" assets
```

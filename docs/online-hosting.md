...
egress IPs are static, shared, or rotating, which is relevant to ATS anti-bot
...
### Secrets
Env vars (visible to any code running in the box, which is risky for untrusted
...
fields, matching the "No Agent" / "skip GitHub connect" decisions made

...
user-invocable: true
---
<!-- GENERATED from src/agents/bodies/interest-letter.md + src/agents/frontmatter/copilot/interest-letter.yaml — edit those sources and run src/scripts/validate/generate_agent_definitions.py -->

...
user-invocable: true
---
<!-- GENERATED from agents/bodies/job-scraper.md + agents/frontmatter/copilot/job-scraper.yaml — edit those sources and run scripts/validate/generate_agent_definitions.py -->

...
Usage:
  python3 scripts/jobs/fetch_stripe_listings.py --search "software engineer" --limit 200
  python3 scripts/jobs/fetch_stripe_listings.py --jd-url 'https://stripe.com/jobs/listing/software-engineer-intern/8031833'
"""

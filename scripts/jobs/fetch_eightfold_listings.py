...
both). Tenants are configured in config/targets.json as "<host>/<domain>"
...
Usage:
  python3 scripts/jobs/fetch_eightfold_listings.py --search "intern" --limit 200
  python3 scripts/jobs/fetch_eightfold_listings.py --jd-url 'https://apply.careers.microsoft.com/careers/job/1970393556911730'
"""

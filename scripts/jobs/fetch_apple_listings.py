...
Usage:
  python3 scripts/jobs/fetch_apple_listings.py --search "software engineer" --limit 200
  python3 scripts/jobs/fetch_apple_listings.py --jd-url 'https://jobs.apple.com/en-us/details/200674164-3401/acoustic-transducer-engineer?team=HRDWR'
"""

...
temperature: 0
---
<!-- GENERATED from src/agents/bodies/discord-reporter.md + src/agents/frontmatter/opencode/discord-reporter.yaml: edit those sources and run src/scripts/validate/generate_agent_definitions.py -->

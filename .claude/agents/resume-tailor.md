...
model: inherit
---
<!-- GENERATED from src/agents/bodies/resume-tailor.md + src/agents/frontmatter/claude/resume-tailor.yaml — edit those sources and run src/scripts/validate/generate_agent_definitions.py -->

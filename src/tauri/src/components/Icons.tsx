...
/* Same gear path as NotificationBell.tsx's SettingsGearButton (that
 * top-right icon is gone now that Settings lives in the sidebar as a
 * real destination, matching Shopify/Slack/Linear's own convention —
 * one shared svg path so both eras of this icon never drift). */

...
/** Stand-in for Home's `.home-guide` "what's next" card. */
export function SkeletonNextCard() {
  return (
    <div className="home-guide skeleton-row" aria-hidden="true">
      <span className="skeleton" style={{ width: "2.5rem", height: "2.5rem", borderRadius: "var(--radius-md)", flexShrink: 0 }} />

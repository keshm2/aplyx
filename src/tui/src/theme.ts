...
// wrap (a wrapped row corrupts the frame under it). 8 tabs at a 1-column
// gap = ~78 cols, plus the two "(N)" count badges and horizontal padding =
// ~90 worst case. Raised 76 -> 92 when the Documents tab landed; every past
// tab-count change bumped this the same way (40->44->54->76).
export const MIN_COLUMNS = 92;
